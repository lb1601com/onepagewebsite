...
$GLOBALS['TL_LANG']['MSC']['currentLogin'][0] = 'Aktuelle Anmeldung';
$GLOBALS['TL_LANG']['MSC']['currentLogin'][1] = 'Aktuelle Anmeldung: %s';
$GLOBALS['TL_LANG']['MSC']['loginCount'] = 'Anmeldeversuche';
...
$GLOBALS['TL_LANG']['MSC']['shortcuts'][1] = 'Wie Sie Ihren Arbeitsablauf durch die Verwendung von <a href="https://contao.org/manual/administration-area.html#backend-tastaturkuerzel" title="Übersicht der Tastaturkürzel auf contao.org" target="_blank">Tastaturkürzeln</a> beschleunigen.';
...
$GLOBALS['TL_LANG']['MSC']['fileManager'] = 'Die Dateiverwaltung öffnen';
$GLOBALS['TL_LANG']['MSC']['pageManager'] = 'Die Seitenstruktur bearbeiten';
$GLOBALS['TL_LANG']['MSC']['filePickerHome'] = 'Zurück zum Dateiwähler';
$GLOBALS['TL_LANG']['MSC']['pagePickerHome'] = 'Zurück zum Seitenwähler';
$GLOBALS['TL_LANG']['MSC']['pickerNoSelection'] = 'Bitte gehen Sie zurück zum Seiten- bzw. Dateiwähler und nehmen Sie dort eine Auswahl vor, bevor Sie den Dialog schließen.';
...
$GLOBALS['TL_LANG']['MSC']['maintenanceMode'] = 'Contao läuft momentan im <strong>Wartungsmodus</strong>, in dem die Webseite (Frontend) nicht verfügbar ist. Deaktivieren Sie den Wartungsmodus nicht, wenn Sie gerade Erweiterungen installieren oder aktualisieren! Die Webseite würde unter Umständen nicht richtig funktionieren.';
$GLOBALS['TL_LANG']['MSC']['maintenanceOff'] = 'Deaktivieren';
$GLOBALS['TL_LANG']['MSC']['buildCacheText'] = 'Der <strong>interne Cache</strong> wurde noch nicht aufgebaut, was sich nachteilig auf die Performance der Applikation auswirkt. Wenn Sie den internen Cache nicht nutzen möchten, können Sie ihn in den Backend-Einstellungen dauerhaft deaktivieren.';
$GLOBALS['TL_LANG']['MSC']['buildCacheLink'] = 'Den Cache aufbauen';
...
$GLOBALS['TL_LANG']['MSC']['activation'] = 'Aktiviert am';
...
/**
 * TL_ROOT/system/modules/backend_tabletree/languages/de/default.php 
 * 
 * Contao extension: backend_tabletree 0.1.3 stable 
 * German translation file 
 * 
 * Copyright : &copy; 2008 Thyon Design, &copy 2011 CyberSpectrum 
 * License   : LGPL 
...
$GLOBALS['TL_LANG']['MSC']['tableTree']['title'] = "Tabelle: %s";
$GLOBALS['TL_LANG']['MSC']['tableTree']['optionsTitle'] = "Auswahl: %s";

// system/modules/calendar/languages/de/default.xlf
...
/**
 * TL_ROOT/system/modules/catalog/languages/de/default.php 
 * 
...
// system/modules/faq/languages/de/default.xlf
...
// system/modules/newsletter/languages/de/default.xlf
 ...
 * Miscellaneous
 */
$GLOBALS['TL_LANG']['CTE']['slickmap'] = array('SlickMap Sitemap', 'Sitemap im Stil von SlickMap CSS.');

/**
 * TL_ROOT/system/modules/taxonomy/languages/de/default.php 
 * 
...
$GLOBALS['TL_LANG']['MSC']['taxonomyTree'] = "Taxonomie-Bedingungen";
